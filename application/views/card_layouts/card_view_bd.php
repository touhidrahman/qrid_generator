<!DOCTYPE html>
<html>
<head><title>ID Card: <?php echo $svc_no_type; ?>/<?php echo $svc_no; ?></title></head>
...
<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="329px" height="206px">
    ...
    <image xlink:href="<?php echo base_url('photos/' . $svc_no_type .'_'. $svc_no . '_img.jpg'); ?>" x="8" y="55" width="76" height="76" />
    <text x="90" y="62" font-size=".8em" font-family="segoe ui" font-weight="700">Service No : <?php echo $svc_no_type; ?>/<?php echo $svc_no; ?></text>
    ...
    <text x="268" y="62" font-size=".6em" font-family="segoe ui" font-weight="800" fill="green" textLength="45" lengthAdjust="spacing"><?php echo $cid; ?></text>
    
    <image xlink:href="<?php echo base_url('assets/sign_pm.jpg'); ?>" x="8" y="135" width="76" height="30" />
    <image xlink:href="<?php echo base_url('signs/' .$svc_no_type .'_'. $svc_no.'_sign.jpg'); ?>" x="128" y="135" width="76" height="30" />
    ...
    <image xlink:href="<?php echo base_url('qr_images/' . $svc_no_type .'_'. $svc_no . '_qr.png'); ?>" x="240" y="118" width="76" height="76" />
